...
describe 'User fulfils rental' do
  it 'and starts review by searching code' do
  ...
  it 'susccesfully without addons' do
    subsidiary = create(:subsidiary, name: 'Almeida Motors')
    user = create(:user, subsidiary: subsidiary)
    manufacture = create(:manufacture)
    fuel_type = create(:fuel_type)
  ...
  it 'successfully with addons' do
    subsidiary = create(:subsidiary, name: 'Almeida Motors')
    user = create(:user, subsidiary: subsidiary)
    manufacture = create(:manufacture)
    fuel_type = create(:fuel_type)
    ...
    create(:insurance, category: category, name: 'Seguro Básico', daily_rate: 20.0)
    create(:insurance, category: category, name: 'Seguro Terceiros', daily_rate: 30.0)
    login_as user, scope: :user
  ...
  it 'and a car must be selected' do
    subsidiary = create(:subsidiary, name: 'Almeida Motors')
    user = create(:user, subsidiary: subsidiary)
    manufacture = create(:manufacture)
    fuel_type = create(:fuel_type)
